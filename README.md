# Awesome-TensorFlow-Chinese with stars
...
> Inspired by <https://github.com/jtoy/awesome-tensorflow> ⭐ 17,551 | 🐛 34 | 📅 2026-02-08

## 推荐产品

* [Lynote AI Humanzier](https://lynote.ai/ai-humanizer) - Best AI Humanizer Free Online Tools（[GitHub](https://github.com/lynote-ai/humanize-text) ⭐ 1,568 | 🐛 19 | 🌐 Python | 📅 2026-08-05）
...
* models:<https://github.com/tensorflow/models> ⭐ 77,651 | 🐛 1,274 | 🌐 Python | 📅 2026-08-17

#### Magenta: Music and Art Generation with Machine Intelligence

* magenta:<https://github.com/tensorflow/magenta> ⚠️ Archived

#### TensorFlow Neural Machine Translation Tutorial

* nmt:<https://github.com/tensorflow/nmt> ⚠️ Archived
...
* [TensorFlow Tutorial](https://github.com/nlintz/TensorFlow-Tutorials) ⭐ 6,029 | 🐛 16 | 🌐 Jupyter Notebook | 📅 2023-08-20 - 基于谷歌的 TensorFlow 框架介绍深度学习
...
* [Sungjoon's TensorFlow-101](https://github.com/sjchoi86/Tensorflow-101) ⭐ 2,593 | 🐛 13 | 🌐 Jupyter Notebook | 📅 2020-03-23 - TensorFlow 教程用 Python 的 Jupyter Notebook
...
* [Neural machine translation between the writings of Shakespeare and modern English using TensorFlow](https://github.com/tokestermw/tensorflow-shakespeare) ⭐ 249 | 🐛 4 | 🌐 Python | 📅 2022-12-11 - This performs a monolingual translation, going from modern English to Shakespeare and vis-versa.
...
* [tf.contrib.learn](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/contrib/learn/python/learn) ⭐ 197,022 | 🐛 2,948 | 🌐 C++ | 📅 2026-08-18 - Simplified interface for Deep/Machine Learning (now part of TensorFlow)
* [TensorFlow-Slim](https://github.com/tensorflow/models/tree/master/inception/inception/slim) ⭐ 77,651 | 🐛 1,274 | 🌐 Python | 📅 2026-08-17 - High-level library for defining models
* [SyntaxNet: Neural Models of Syntax](https://github.com/tensorflow/models/tree/master/syntaxnet) ⭐ 77,651 | 🐛 1,274 | 🌐 Python | 📅 2026-08-17 - A TensorFlow implementation of the models described in [Globally Normalized Transition-Based Neural Networks, Andor et al. (2016)](http://arxiv.org/pdf/1603.06042.pdf)
* [Sonnet](https://github.com/deepmind/sonnet) ⭐ 9,951 | 🐛 43 | 🌐 Python | 📅 2026-07-07 - Sonnet is DeepMind's library built on top of TensorFlow for building complex neural networks.
...
* [Globally Normalized Transition-Based Neural Networks](http://arxiv.org/abs/1603.06042) - This paper describes the models behind [SyntaxNet](https://github.com/tensorflow/models/tree/master/syntaxnet) ⭐ 77,651 | 🐛 1,274 | 🌐 Python | 📅 2026-08-17.
